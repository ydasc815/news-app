...
class THListAdapter(c: Context, private val listItem: List<NewsData>) :
    RecyclerView.Adapter<THListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.newsItem.setOnClickListener {
            ...
            it.findNavController()
                .navigate(R.id.action_topHeadlinesFragment_to_newsDetailsFragment, bundle)
        }
    }
