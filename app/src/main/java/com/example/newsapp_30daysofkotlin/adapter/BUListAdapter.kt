...
class BUListAdapter(c: Context, private val listItem: List<NewsData>) :
    RecyclerView.Adapter<BUListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.newsItem.setOnClickListener {
            ...
            it.findNavController()
                .navigate(R.id.action_businessFragment_to_newsDetailsFragment, bundle)
        }
    }
