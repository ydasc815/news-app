...
class SPListAdapter(c: Context, private val listItem: List<NewsData>) :
    RecyclerView.Adapter<SPListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.newsItem.setOnClickListener {
            ...
            it.findNavController()
                .navigate(R.id.action_sportsFragment_to_newsDetailsFragment, bundle)
        }
    }
