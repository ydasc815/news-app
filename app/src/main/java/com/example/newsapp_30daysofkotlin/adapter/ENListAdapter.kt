...
class ENListAdapter(c: Context, private val listItem: List<NewsData>) :
    RecyclerView.Adapter<ENListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.newsItem.setOnClickListener {
            ...
            it.findNavController()
                .navigate(R.id.action_entertainmentFragment_to_newsDetailsFragment, bundle)
        }
    }
