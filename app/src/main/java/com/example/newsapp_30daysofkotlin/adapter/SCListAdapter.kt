...
class SCListAdapter(c: Context, private val listItem: List<NewsData>) :
    RecyclerView.Adapter<SCListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.newsItem.setOnClickListener {
            ...
            it.findNavController()
                .navigate(R.id.action_scienceFragment_to_newsDetailsFragment, bundle)
        }
    }
