...
class HLListAdapter(c: Context, private val listItem: List<NewsData>) :
    RecyclerView.Adapter<HLListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.newsItem.setOnClickListener {
            ...
            it.findNavController()
                .navigate(R.id.action_healthFragment_to_newsDetailsFragment, bundle)
        }
    }
