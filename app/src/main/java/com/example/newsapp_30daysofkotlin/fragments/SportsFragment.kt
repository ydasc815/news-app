...
import com.example.newsapp_30daysofkotlin.adapter.SPListAdapter
import com.example.newsapp_30daysofkotlin.databinding.FragmentSportsBinding
...
class SportsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val url =
            "https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=17ae04f50bfd4413811aeb69e0a062f9"
        val json = JsonObjectRequest(Request.Method.GET, url, null,
            Response.Listener { response ->
                ...
                binding.recyclerView.adapter = SPListAdapter(requireContext(), list)
