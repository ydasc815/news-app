...
import com.example.newsapp_30daysofkotlin.adapter.SCListAdapter
import com.example.newsapp_30daysofkotlin.databinding.FragmentScienceBinding
...
class ScienceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val url =
            "https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=17ae04f50bfd4413811aeb69e0a062f9"
        val json = JsonObjectRequest(Request.Method.GET, url, null,
            Response.Listener { response ->
                ...
                binding.recyclerView.adapter = SCListAdapter(requireContext(), list)
