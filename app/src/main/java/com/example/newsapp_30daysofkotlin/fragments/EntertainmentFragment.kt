...
import com.example.newsapp_30daysofkotlin.adapter.ENListAdapter
import com.example.newsapp_30daysofkotlin.databinding.FragmentEntertainmentBinding
...
class EntertainmentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_entertainment, container, false
        )
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val url =
            "https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=17ae04f50bfd4413811aeb69e0a062f9"
        val json = JsonObjectRequest(Request.Method.GET, url, null,
            Response.Listener { response ->
                ...
                binding.recyclerView.adapter = ENListAdapter(requireContext(), list)
